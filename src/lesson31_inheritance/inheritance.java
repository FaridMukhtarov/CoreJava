...
public class inheritance extends NeqliyyatVasitesi{
    public static void main(String[] args) {
        ...
        Bu yol ilə, kodun yenidən istifadəsi və baxımı asanlaşır. Misal üzərində, "Person" class-ının xüsusiyyətləri
        və funksiyaları "Employee" class-ı tərəfindən extends yolu ilə istifadə edilə bilər. Bu yol ilə "Employee"
        class-ına aid xüsusiyyətlər və funksiyalar əlavə edilərkən "Person" class-ından extends yolu ilə istifadə edilmiş
